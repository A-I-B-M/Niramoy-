...
<head>
  ...
  <title>Appointment Details - Niramoy</title>
  <link rel="stylesheet" href="apppointmentDetails.css" />
  ...
  <div class="d-flex">
    <aside class="sidebar d-flex flex-column p-3">
      ...
      <ul class="nav flex-column">
        ...
        <li class="nav-item"><a class="nav-link active" href="appointmentDetails.php">Appointment Details</a></li>
